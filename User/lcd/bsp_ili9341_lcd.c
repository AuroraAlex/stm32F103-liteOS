...
__inline extern void                 ILI9341_Write_Cmd           ( uint16_t usCmd );
__inline extern void                 ILI9341_Write_Data          ( uint16_t usData );
__inline extern uint16_t             ILI9341_Read_Data           ( void );
